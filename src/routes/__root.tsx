...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FeeSync AI — Smart College Fee Reminder Bot" },
      {
        name: "description",
        content:
          "FeeSync AI tracks college fee payments and sends smart WhatsApp, email and push reminders to students and parents.",
      },
